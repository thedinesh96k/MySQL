...
# for view values with conditions -
...
# selection by using operators -
#And
SELECT Pcode,pname FROM products WHERE productline="Classic Cars" AND MRP<150;

#OR
SELECT Pcode,pname FROM products WHERE productline="Classic Cars" OR MRP<150;

#IN
SELECT* FROM myemp WHERE DEP_ID in(60,50);

# NOT IN
SELECT* FROM myemp WHERE DEP_ID  NOT in(60,50);
